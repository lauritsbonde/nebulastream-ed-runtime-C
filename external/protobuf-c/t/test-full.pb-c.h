...
typedef struct Foo__SubMess Foo__SubMess;
typedef struct Foo__SubMess__SubSubMess Foo__SubMess__SubSubMess;
typedef struct Foo__TestFieldNo15 Foo__TestFieldNo15;
typedef struct Foo__TestFieldNo16 Foo__TestFieldNo16;
typedef struct Foo__TestFieldNo2047 Foo__TestFieldNo2047;
typedef struct Foo__TestFieldNo2048 Foo__TestFieldNo2048;
typedef struct Foo__TestFieldNo262143 Foo__TestFieldNo262143;
typedef struct Foo__TestFieldNo262144 Foo__TestFieldNo262144;
typedef struct Foo__TestFieldNo33554431 Foo__TestFieldNo33554431;
typedef struct Foo__TestFieldNo33554432 Foo__TestFieldNo33554432;
typedef struct Foo__TestMess Foo__TestMess;
typedef struct Foo__TestMessPacked Foo__TestMessPacked;
typedef struct Foo__TestMessOptional Foo__TestMessOptional;
typedef struct Foo__TestMessOneof Foo__TestMessOneof;
typedef struct Foo__TestMessRequiredInt32 Foo__TestMessRequiredInt32;
typedef struct Foo__TestMessRequiredSInt32 Foo__TestMessRequiredSInt32;
typedef struct Foo__TestMessRequiredSFixed32 Foo__TestMessRequiredSFixed32;
typedef struct Foo__TestMessRequiredInt64 Foo__TestMessRequiredInt64;
typedef struct Foo__TestMessRequiredSInt64 Foo__TestMessRequiredSInt64;
typedef struct Foo__TestMessRequiredSFixed64 Foo__TestMessRequiredSFixed64;
typedef struct Foo__TestMessRequiredUInt32 Foo__TestMessRequiredUInt32;
typedef struct Foo__TestMessRequiredFixed32 Foo__TestMessRequiredFixed32;
typedef struct Foo__TestMessRequiredUInt64 Foo__TestMessRequiredUInt64;
typedef struct Foo__TestMessRequiredFixed64 Foo__TestMessRequiredFixed64;
typedef struct Foo__TestMessRequiredFloat Foo__TestMessRequiredFloat;
typedef struct Foo__TestMessRequiredDouble Foo__TestMessRequiredDouble;
typedef struct Foo__TestMessRequiredBool Foo__TestMessRequiredBool;
typedef struct Foo__TestMessRequiredEnum Foo__TestMessRequiredEnum;
typedef struct Foo__TestMessRequiredEnumSmall Foo__TestMessRequiredEnumSmall;
typedef struct Foo__TestMessRequiredString Foo__TestMessRequiredString;
typedef struct Foo__TestMessRequiredBytes Foo__TestMessRequiredBytes;
typedef struct Foo__TestMessRequiredMessage Foo__TestMessRequiredMessage;
typedef struct Foo__EmptyMess Foo__EmptyMess;
typedef struct Foo__DefaultRequiredValues Foo__DefaultRequiredValues;
typedef struct Foo__DefaultOptionalValues Foo__DefaultOptionalValues;
typedef struct Foo__LowerCase Foo__LowerCase;
typedef struct Foo__AllocValues Foo__AllocValues;
typedef struct Foo__TestRequiredFieldsBitmap Foo__TestRequiredFieldsBitmap;
typedef struct Foo__TestFieldFlags Foo__TestFieldFlags;
typedef struct Foo__TestMessageCheck Foo__TestMessageCheck;
typedef struct Foo__TestMessageCheck__SubMessage Foo__TestMessageCheck__SubMessage;
typedef struct Foo__TestMessSubMess Foo__TestMessSubMess;
...
struct  Foo__SubMess__SubSubMess
{
  ...
  const char *str1;
  protobuf_c_boolean has_str2;
  ProtobufCBinaryData str2;
};
...
extern uint8_t foo__sub_mess__sub_sub_mess__str2__default_value_data[];
#define FOO__SUB_MESS__SUB_SUB_MESS__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&foo__sub_mess__sub_sub_mess__descriptor) \
    , 0, 100, 0,NULL, 0, { 8, foo__sub_mess__sub_sub_mess__bytes1__default_value_data }, foo__sub_mess__sub_sub_mess__str1__default_value, 0, { 12, foo__sub_mess__sub_sub_mess__str2__default_value_data } }
...
struct  Foo__TestFieldNo33554431
{
  ProtobufCMessage base;
  const char *test;
};
...
struct  Foo__TestFieldNo33554432
{
  ProtobufCMessage base;
  const char *test;
};
...
typedef enum {
  ...
  FOO__TEST_MESS_ONEOF__TEST_ONEOF_TEST_MESSAGE = 18
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FOO__TEST_MESS_ONEOF__TEST_ONEOF__CASE)
} Foo__TestMessOneof__TestOneofCase;

struct  Foo__TestMessOneof
{
  ProtobufCMessage base;
...
struct  Foo__TestMessRequiredInt32
{
  ProtobufCMessage base;
  int32_t test;
};
...
struct  Foo__TestMessRequiredSInt32
{
  ProtobufCMessage base;
  int32_t test;
};
...
struct  Foo__TestMessRequiredSFixed32
{
  ProtobufCMessage base;
  int32_t test;
};
...
struct  Foo__TestMessRequiredInt64
{
  ProtobufCMessage base;
  int64_t test;
};
...
struct  Foo__TestMessRequiredSInt64
{
  ProtobufCMessage base;
  int64_t test;
};
...
struct  Foo__TestMessRequiredSFixed64
{
  ProtobufCMessage base;
  int64_t test;
};
...
struct  Foo__TestMessRequiredUInt32
{
  ProtobufCMessage base;
  uint32_t test;
};
...
struct  Foo__TestMessRequiredFixed32
{
  ProtobufCMessage base;
  uint32_t test;
};
...
struct  Foo__TestMessRequiredUInt64
{
  ProtobufCMessage base;
  uint64_t test;
};
...
struct  Foo__TestMessRequiredFixed64
{
  ProtobufCMessage base;
  uint64_t test;
};
...
struct  Foo__TestMessRequiredFloat
{
  ProtobufCMessage base;
  float test;
};
...
struct  Foo__TestMessRequiredDouble
{
  ProtobufCMessage base;
  double test;
};
...
struct  Foo__TestMessRequiredBool
{
  ProtobufCMessage base;
...
struct  Foo__TestMessRequiredEnum
{
  ProtobufCMessage base;
  Foo__TestEnum test;
};
...
struct  Foo__TestMessRequiredEnumSmall
{
  ProtobufCMessage base;
...
struct  Foo__TestMessRequiredString
{
  ProtobufCMessage base;
  const char *test;
};
...
struct  Foo__TestMessRequiredBytes
{
  ProtobufCMessage base;
...
struct  Foo__TestMessRequiredMessage
{
  ProtobufCMessage base;
  Foo__SubMess *test;
};
...
struct  Foo__DefaultRequiredValues
{
  ProtobufCMessage base;
  int32_t v_int32;
  uint32_t v_uint32;
...
struct  Foo__DefaultOptionalValues
{
  ProtobufCMessage base;
...
struct  Foo__TestRequiredFieldsBitmap
{
  ProtobufCMessage base;
  const char *field1;
  const char *field2;
...
struct  Foo__TestMessageCheck__SubMessage
{
  ProtobufCMessage base;
  const char *str;
};
...
struct  Foo__TestMessageCheck
{
  ...
  const char *required_string;
  size_t n_repeated_string;
  const char **repeated_string;
