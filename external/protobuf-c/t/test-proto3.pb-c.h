...
typedef struct Foo__Person__PhoneNumber__Comment Foo__Person__PhoneNumber__Comment;
...
struct  Foo__Person__PhoneNumber__Comment
{
...
typedef struct Foo__DirLookup_Service Foo__DirLookup_Service;
