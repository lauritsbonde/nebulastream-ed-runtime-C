...
#ifndef PROTOBUF_C_EndDeviceProtocol_2eproto__INCLUDED
#define PROTOBUF_C_EndDeviceProtocol_2eproto__INCLUDED
...
typedef struct _EndDeviceProtocol__Data EndDeviceProtocol__Data;
typedef struct _EndDeviceProtocol__Output EndDeviceProtocol__Output;
typedef struct _EndDeviceProtocol__Output__QueryResponse EndDeviceProtocol__Output__QueryResponse;
typedef struct _EndDeviceProtocol__Expression EndDeviceProtocol__Expression;
typedef struct _EndDeviceProtocol__MapOperation EndDeviceProtocol__MapOperation;
typedef struct _EndDeviceProtocol__FilterOperation EndDeviceProtocol__FilterOperation;
typedef struct _EndDeviceProtocol__WindowOperation EndDeviceProtocol__WindowOperation;
typedef struct _EndDeviceProtocol__Operation EndDeviceProtocol__Operation;
typedef struct _EndDeviceProtocol__Query EndDeviceProtocol__Query;
typedef struct _EndDeviceProtocol__Message EndDeviceProtocol__Message;
...
typedef enum {
  ...
  END_DEVICE_PROTOCOL__DATA__DATA__DOUBLE = 11
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(END_DEVICE_PROTOCOL__DATA__DATA)
} EndDeviceProtocol__Data__DataCase;

struct  _EndDeviceProtocol__Data
{
...
struct  _EndDeviceProtocol__Output__QueryResponse
{
  ProtobufCMessage base;
  int32_t id;
  size_t n_response;
...
struct  _EndDeviceProtocol__Output
{
  ProtobufCMessage base;
  size_t n_responses;
...
struct  _EndDeviceProtocol__Expression
{
  ProtobufCMessage base;
...
struct  _EndDeviceProtocol__MapOperation
{
  ProtobufCMessage base;
  size_t n_function;
...
struct  _EndDeviceProtocol__FilterOperation
{
  ProtobufCMessage base;
  size_t n_predicate;
...
struct  _EndDeviceProtocol__WindowOperation
{
  ProtobufCMessage base;
  int32_t size;
...
typedef enum {
  ...
  END_DEVICE_PROTOCOL__OPERATION__OPERATION_WINDOW = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(END_DEVICE_PROTOCOL__OPERATION__OPERATION)
} EndDeviceProtocol__Operation__OperationCase;

struct  _EndDeviceProtocol__Operation
{
  ProtobufCMessage base;
...
struct  _EndDeviceProtocol__Query
{
  ProtobufCMessage base;
  /*
...
struct  _EndDeviceProtocol__Message
{
  ProtobufCMessage base;
  size_t n_queries;
...
#endif  /* PROTOBUF_C_EndDeviceProtocol_2eproto__INCLUDED */
